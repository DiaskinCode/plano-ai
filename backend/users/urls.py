...
from .social_auth import authenticate_google_user, authenticate_apple_user, link_oauth_account
...
urlpatterns = [
    ...
    path('auth/google/', authenticate_google_user, name='auth_google'),
    path('auth/apple/', authenticate_apple_user, name='auth_apple'),
    path('auth/link/<str:provider>/', link_oauth_account, name='link_oauth'),
    ...
    # Progress tracking
    path('progress/', ProgressStatsView.as_view(), name='progress_stats'),
    path('progress/update/', UpdateProgressView.as_view(), name='update_progress'),
    path('progress/streak/', StreakStatsView.as_view(), name='streak_stats'),
