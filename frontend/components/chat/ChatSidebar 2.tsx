    ...
    <>
      ...
      {isOpen && (
        <TouchableOpacity
          ...
          onPress={onClose}
        >
          <BlurView intensity={colors.liquidGlass.blurLight} tint="dark" style={StyleSheet.absoluteFill} />
        </TouchableOpacity>
      )}
      ...
      >
        {/* Header */}
        <BlurView intensity={colors.liquidGlass.blurMedium} tint="dark" style={styles.headerBlur}>
